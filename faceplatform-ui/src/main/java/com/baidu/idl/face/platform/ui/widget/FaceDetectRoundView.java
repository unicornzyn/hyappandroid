...
public class FaceDetectRoundView extends View {
    ...
    public static final float HEIGHT_EXT_RATIO =  0;//0.2f;
    ...
    public FaceDetectRoundView(Context context, AttributeSet attrs) {
        ...
        mFaceRectPaint.setStyle(Paint.Style.FILL);
        mFaceRectPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mFaceDetectRect == null) {
            ...
            mFaceDetectRect = new Rect((int) (x - r - CIRCLE_SPACE),
                    (int) (y - r - CIRCLE_SPACE),
                    (int) (x + r + 2 * CIRCLE_SPACE),
                    (int) (y + r + 2 * CIRCLE_SPACE));
        }
        mX = x;
        mY = y;
        mR = r;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mFaceDetectRect != null) {
            canvas.drawRect(mFaceDetectRect, mPathPaint);
        }
    }
